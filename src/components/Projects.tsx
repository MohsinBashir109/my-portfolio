            ...
            >
              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-4">
                  <h3 className="font-geist text-2xl font-semibold text-slate-50 transition-colors group-hover:text-brand-primary">
                    {project.title}
                  </h3>
                ...
                <p className="mt-3 text-sm font-normal leading-relaxed text-slate-400">{project.description}</p>
                ...
                <ul className="mt-5 flex flex-wrap gap-2" role="list" aria-label="Tech stack">
                  {project.stack.map((t) => {
                    ...
                    return (
                      <li key={t}>
                        <span className="chip-lift inline-flex items-center gap-1.5 rounded-md border border-border-subtle bg-bg-elevated/80 px-2 py-1 font-mono text-[11px] font-medium text-slate-300 motion-reduce:hover:scale-100">
                          {StackIcon ? (
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    className="btn-press focus-ring inline-flex items-center justify-center rounded-full border border-border-subtle bg-transparent px-4 py-2 text-xs text-slate-50 hover:border-border-subtle hover:bg-bg-surface motion-reduce:hover:translate-y-0 motion-reduce:active:scale-100"
                  >
                    GitHub
                  </a>
                  {project.live ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn-press focus-ring inline-flex items-center justify-center rounded-full border border-brand-primary/40 bg-brand-primary px-4 py-2 text-xs text-white shadow-[0_0_28px_-8px_rgba(79,140,255,0.35)] hover:border-brand-primary-hover hover:bg-brand-primary-hover motion-reduce:hover:translate-y-0 motion-reduce:active:scale-100"
                    >
                      Live demo
                    </a>
                  ) : (
                    <span className="inline-flex items-center rounded-full border border-dashed border-border-subtle bg-bg-elevated/40 px-4 py-2 font-mono text-xs font-medium text-slate-500">
                      Live demo — add URL
                    </span>
                  )}
                </div>
